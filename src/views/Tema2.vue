  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.container.justify-content-around.align-items-center
      ...
      .titulo-sexto.color-acento-contenido.mb-3
        h5 Figura 1
        br
        span.fst-italic Componentes del suelo
          ...
          ol.lista-ol--cuadro
              li 
                .lista-ol--cuadro__vineta.color-acento-contenido
                  span a
                |  Abonos orgánicos
          p.mb-5(data-aos='fade-right') Las ventajas de algunos tipos de abonos orgánicos son: 
        ...
        .row.justify-content-center.mb-5
          .col-lg-8
            .cajon.color-acento-botones.p-4.mb-4(style="background-color: #fff2df")
              p.mb-0 Los abonos fermentados, en especial, generan ventajas sobre los cultivos agroecológicos.
    ...
    .row.justify-content-center.mb-5
      .col-lg-4
        .tarjeta.tarjeta-slide2.position-relative.h-100
            .tarjeta-slide2__contenido2.p-4.p-xl-5(style="background-color: #e1f0ef ").p-4
              ul.lista-ul--color
                  li
                    i.fas.fa-atom
        ...
        .tarjeta.tarjeta-slide2.position-relative.h-100
            ...
            .tarjeta-slide2__portada(style="background-color: #f2eddc").p-3.d-flex.align-items-center.justify-content-center
              .contenido
                ...
                .imagen
                  img(src='@/assets/curso/temas/a4.svg', alt='' style='width: 256px').m-auto
              

    .row.container.justify-content-around.align-items-center
      .row.justify-content-center.mb-5
        .col-lg-9.position-relative
          p.mb-5(data-aos='fade-right').fw-bold Algunas características de estos fertilizantes o inoculantes biológicos, son:
          ...
          .crd.crd--avatarHorizontal.fondo-color-tarjetas-conectadas.tarjeta.espacios-color-tarjeta2-tema2.py-4
            .row.align-items-center
              ...
              .col
                h5.texto-tarjetas-conectadas Mejoran la formación y estructura
    ...
    .row.container.justify-content-around.align-items-center
      ...
      h3 Microorganismos empleados en los inoculantes biológicos

      p Los microorganismos empleados como inoculantes biológicos son fuente de nutrientes mayores y menores, además de acondicionadores de suelo que mejoran la estructura y la absorción de minerales en los cultivos. Se detallan en el siguiente esquema:
    ...
    .row.container.justify-content-around.align-items-center
      ...
      .row.tarjeta.tarjeta--blanca.p-2.p-md-3
        ...
        figure
          .video
            iframe(width="560" height="315" src="https://www.youtube.com/embed/hIMX8NY-49Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .row.container.justify-content-around.align-items-center
          ...
          .col-lg-7.p-3
            ...
            p.texto-color-superior En Colombia, se han desarrollado mecanismos de protección de los ecosistemas, propendiendo por el desarrollo industrial, con minimización de los impactos generados por actividades antrópicas, a través de una normatividad sanitaria y ambiental que busca proteger a las actividades agropecuarias y agrícolas de posibles enfermedades, o de la expansión de contagios que afecten gravemente las actividades en el campo.
              ...
              br
              br
              |El ICA cuenta con las siguientes guías y normas:
